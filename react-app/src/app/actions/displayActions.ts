...
export const displayEditMidiModal = (): ThunkAction<void, RootState, null, DisplayAction> => (dispatch) => {
    dispatch({ type: SHOW_EDIT_MIDI_MODAL });
}
export const closeEditMidiModal = (): ThunkAction<void, RootState, null, DisplayAction> => (dispatch) => {
    dispatch({ type: CLOSE_EDIT_MIDI_MODAL });
}
